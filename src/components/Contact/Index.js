  ...
  return (
    <div className="min-h-[75vh]">
      ...
      >
        <input
          type="text"
          className="px-4 my-3 lg:py-2 lg:my-2 h-24 lg:h-16 w-2/3 bg-black rounded-lg lg:w-1/2"
          name="user_name"
          placeholder="Name"
          required
        />
        ...
        />
        <textarea
          className="px-4 my-3 py-2 lg:py-2 lg:my-2 h-60 lg:h-44 w-2/3 bg-black rounded-lg lg:w-1/2"
          name="message"
          placeholder="Message"
          required
        />
